...
/* ------------------------------------------------ */
/* --- 表示メニュー --- */
#define MENU_ALL 0				/* すべてのランク				*/
#define MENU_SORT_A 1			/* 昇順にソート					*/
#define MENU_SORT_D 2			/* 降順にソート					*/
#define MENU_SORT_P	3			/* すべてをページに分割			*/
#define MENU_ILLIGAL -1			/* エラーデータ					*/

/* --- 選択キー --- */
#define KEY_CODE 0				/* 都道府県コード				*/
#define KEY_AREA 1				/* 面積							*/
#define KEY_POPULATION 2		/* 総人口						*/
#define KEY_MAN 3				/* 人口：男						*/
#define KEY_WOMAN 4				/* 人口：女						*/

/* --- データファイル関係 --- */
#define MAX_DATACNT 500			/* データファイルのデータ最大数 */
#define LINE_PAR_PAGE 10		/* 1表示ページ当たりの表示行数	*/

/* ------------------------------------------------ */
/* type definition									*/
/* ------------------------------------------------ */
typedef struct jinko {
	char	code[8];		// 団体コード
	char	name[20];		// 都道府県名
	double	area;			// 面積
	int		population;		// 人口：合計
	int		man;			// 人口：男
	int		woman;			// 人口：女
} JINKO_DATA;
